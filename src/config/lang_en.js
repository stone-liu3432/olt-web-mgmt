var en = {
    ...
    opt_power: "Optical power",
    opt_limit: "Optical power limit",
    opt_below_limit: "Optical power below limit",
    opt_exceed_limit: "Optical power exceeds limit",
    no_operation: "No operation",
    close_pon_opt: "Turn off PON optical",
    reason: " Reason ",
    optstate: " PON optical ",
    ...
    deny: " Deny ",
    permit: " Permit ",
    cli_acl: "CLI Access Control",
    vtyacl: "CLI ACL Bind Name",
    vtyacl_ipv6: "IPv6 CLI ACL Bind Name",
    cli_acl_list: "CLI ACL Bind List",
    afi: "IP Protocol",
    hostip: "IP Address",
    exact: "Exact Match",
    bind_cli_acl: "Bind ACL to CLI",
    bind_cli_acl_tips: "No ACL available, please add it first.",
    telnet: " telnet ",
