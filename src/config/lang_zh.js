var zh = {
    ...
    opt_power: "光功率",
    opt_limit: "光功率上下限",
    opt_below_limit: "光功率低于限制",
    opt_exceed_limit: "光功率超过限制",
    no_operation: "不执行任何操作",
    close_pon_opt: "关闭PON发光",
    reason: "原因",
    optstate: " PON发光 ",
    lower_limit: "下限",
    ...
    loid_tips4:
        '例：LOID为"test"，count为2时，将依次添加“test01”，“test02”两个LOID。',
    ...
    cli_acl_list: "绑定CLI ACL列表",
    afi: "IP协议",
    hostip: "IP地址",
    exact: "精确匹配",
    bind_cli_acl: "绑定ACL到CLI",
    bind_cli_acl_tips: "无可用ACL，请先添加。",
    telnet: " telnet ",
