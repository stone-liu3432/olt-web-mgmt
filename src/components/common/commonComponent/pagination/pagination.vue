<template>
    <ul class="pagination" v-if="!hide">
        <li :class="index > 1 ? '' : 'disabled'" @click="changeIndex(1)" title="First">&lt;&lt;</li>
        <li :class="index > 1 ? '' : 'disabled'" @click="changeIndex(index - 1)" title="Prev">&lt;</li>
        ...
        <li v-if="index > 2" @click="changeIndex(index - 2)">{{ index - 2 }}</li>
        <li v-if="index > 1" @click="changeIndex(index - 1)">{{ index - 1 }}</li>
        <li class="actived" @click="changeIndex(index)">{{ index }}</li>
        <li v-if="page - 1 >= index" @click="changeIndex(index + 1)">{{ index + 1 }}</li>
        <li v-if="page - 2 >= index" @click="changeIndex(index + 2)">{{ index + 2 }}</li>
