        ...
        <div>
            ...
            <div class="time-item">
                ...
                <div class="time-set">
                    <label for="time_set_manual">
                        ...
                        <span
                            class="text"
                        >{{ lanMap['manual_s'] + lanMap['config'] + lanMap['time_set'] }}</span>
                    </label>
                </div>
            </div>
            ...
            <div v-if="!set_time_type">
                ...
                <div class="time-item">
                    ...
                    <span>
                        <input
                            type="text"
                            v-model.number="poll_interval_time"
                            placeholder="ex: 7"
            ...
            <div class="btn-item">
                <a
                    ...
                    @click="handle_set_time"
                    v-if="set_time_type"
                >{{ lanMap['apply'] }}</a>
                <a
                    href="javascript:void(0);"
                    @click="set_ntp_submit"
                    v-if="!set_time_type"
                >{{ lanMap['apply'] }}</a>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        set_ntp_submit() {
            ...
            if (
                isNaN(this.poll_interval_time) ||
                this.poll_interval_time >= Math.pow(2, 31) / 60 / 60 / 24
            ) {
                this.$message({
                    type: "error",
                    text:
        ...
        february() {
            if (
                (this.set_time.year % 4 == 0 &&
                    this.set_time.year % 100 != 0) ||
                this.set_time.year % 400 == 0
            ) {
            ...
            if (
                this.set_time.month == 4 ||
                this.set_time.month == 6 ||
                this.set_time.month == 9 ||
                this.set_time.month == 11
            ) {
                this.days = [
                    1,
                    2,
...
span.time-set {
    ...
    input:checked + i.icon {
        background: url("../../../assets/radio_button_selected.png") no-repeat
            3px 3px;
    }
    input[type="radio"] {
        display: none;
