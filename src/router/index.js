...
//  main
const main = () =>
    import(/* webpackChunkName: "main-page" */ "@/components/page/main");
const contentArea = () =>
    import(/* webpackChunkName: "main-page" */ "@/components/page/content");
const status = () =>
    import(
        /* webpackChunkName: "main-page" */ "@/components/common/system/status"
    );
const onuAllow = () =>
    import(
        /* webpackChunkName: "main-page" */ "@/components/common/pon/onuAllow"
    );
const vlanMgmt = () =>
    import(
...
router.afterEach((to, from) => {
    ...
    if (store.state.menu.data) {
        let menu = store.state.menu.data.menu,
